...
def bar_plot(x,y1,y2,datasets):
    ...
    ax.set_xlabel('Boosting iteration', fontsize=FONTSIZE)
    ...
    #     ax2.set_ylim(0, 160)
    #     ax2.yaxis.set_major_locator(FixedLocator([0,40,80,120,160]))
    ...
    # elif dataset_name == "ton-iot":
    #     ax2.set_ylim(0, 800)
    #     ax2.yaxis.set_major_locator(FixedLocator([0,200,400,600,800]))
    # elif dataset_name == "unsw-nb15":
    #     ax2.set_ylim(0, 5000)
    #     ax2.yaxis.set_major_locator(FixedLocator([0,1250,2500,3750,5000]))
    ...
    pp = PdfPages("./C4_boost_num/param_boost_num.pdf")
...
df = pd.read_csv("/home/zhuyijia/prototypical/V6_complete/exp_boost_num.csv",header=0)
for dataset_name in datasets: #
    ...
    # unique_boost_num
    unique_boost_num = df_dataset['boost_num'].unique()
    unique_boost_num = [1,2,3,4,5,6,7,8]
    weighted_tpr_list = []
    all_acc_list = []
    rule_num_list = []
    # unique_boost_num
    for threshold in unique_boost_num:
        # unique_boost_num
        df_threshold = df_dataset[df_dataset['boost_num'] == threshold]
    ...
    data = {
        'unique_boost_num': unique_boost_num,
    ...
    df_sorted = df_tmp.sort_values(by='unique_boost_num')

    x.append(df_sorted['unique_boost_num'])
