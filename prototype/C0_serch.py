...
if __name__=="__main__":
    ...
    parser.add_argument('--dataset', type=str, default='cicids-2018', help='ton-iot / ISCX / cicids')
    ...
    for dataset in [args.dataset]:#'iscx','cicids','ton-iot','unibs',"unsw-iot"
        ...
        output_csv = "C0_serch_proto_"+str(args.attack_max_samples)+str(args.test_split_size)+".csv"
