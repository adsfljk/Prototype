...
def main(args,add_order,output_csv):
    ...
    #######################################################################################
        ...
        experi_csv = [args.dataset,log_class_name,args.cls_threshold,args.boost_num,args.temperature,args.prune_T,args.prune_rule,args.dbscan_eps,detection_acc,choose_TPR,choose_FPR,final_acc,\
                      precision,recall,f1,rule_num,old_rule_num,remain_num,conflict_rule_num,remain_conflict_rules_num,save_num,training_time]
...
if __name__=="__main__":
    ...
    parser.add_argument('--export_entry', type=bool, default=True, help="export_entry")
    ...
    for dataset in [args.dataset]:#'iscx','cicids','ton-iot','unibs',"unsw-iot"
        ...
        record_list_name = ['dataset','add_order','choose_threshold','boost_num','temperature','prune_T','prune_rule','dbscan_eps',\
                            'detection_acc','choose_TPR','choose_FPR','final_acc','precision','recall','f1',\
                                'rule_number',"next_rule_num","remain_num","conflict_rule_num","remain_conflict_rules_num","save_num","time"]

        output_csv = "app50_ACC_"+str(args.attack_max_samples)+str(args.test_split_size)+".csv"
