...
def main(args,add_order,output_csv):
    ...
    for idx_log_class,log_class in enumerate(add_order):
        ...
        for boost_iter in range(args.boost_num):
            ...
            # if model.class_prototype[idx].shape[1] == 0:
            #     continue
            prune_pro_num = 0
    ...
    #######################################################################################
        ...
        experi_csv = [args.dataset,log_class_name,args.cls_threshold,args.boost_num,args.temperature,args.prune_T,args.prune_rule,args.dbscan_eps,detection_acc,choose_TPR,choose_FPR,final_acc,\
