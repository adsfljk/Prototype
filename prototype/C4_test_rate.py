...
def main(args,add_order,output_csv):
    ...
    #######################################################################################
        ...
        experi_csv = [args.dataset,log_class_name,args.cls_threshold,args.test_split_size,args.boost_num,args.temperature,args.prune_T,args.prune_rule,args.dbscan_eps,detection_acc,choose_TPR,choose_FPR,final_acc,\
...
if __name__=="__main__":
    ...
    for dataset in [args.dataset]:#'iscx','cicids','ton-iot','unibs',"unsw-iot"
        ...
        if dataset == 'iscx':
            ...
            # 9.15 DT
            args.boost_num = 5
            args.temperature = 0.07623023
            args.prune_T = 7
            args.prune_rule = 0
            args.dbscan_eps = 0.0778162593984094
        ...
        record_list_name = ['dataset','add_order','choose_threshold','test_rate','boost_num','temperature','prune_T','prune_rule','dbscan_eps',\
        ...
        output_csv = "exp_test_rate_proto.csv"
