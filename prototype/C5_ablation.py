...
if __name__=="__main__":
    ...
    parser.add_argument('--output_csv', type=str, default="exp_prune.csv", help='output_csv')
    ...
    parser.add_argument('--save_model', type=str, default='./final_model/iot', help='path to save model')
