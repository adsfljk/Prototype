...
def main(args,add_order,output_csv):
    ...
    for idx_log_class,log_class in enumerate(add_order):
        ...
        for boost_iter in range(args.boost_num):
            ...
            if args.init_methed == "boost_train":
                ...
                model = init_model(model, args, args.init_type,args.dbscan_eps,args.min_samples, X_train, y_train, feature_min, feature_max)
    ...
    #######################################################################################
        ...
        if args.export_entry ==True:
            export_range(idx_log_class,args,num_classes,log_class,attack_classes,\
        ...
        experi_csv = [args.dataset,log_class_name,args.init_type,args.cls_threshold,args.boost_num,args.temperature,args.prune_T,args.prune_rule,args.dbscan_eps,detection_acc,choose_TPR,choose_FPR,final_acc,\
                      precision,recall,f1,rule_num,old_rule_num,remain_num,conflict_rule_num,remain_conflict_rules_num,save_num]
...
if __name__=="__main__":
    ...
    parser.add_argument('--max_proto_num', type=int, default=300, help='initial prototype number')
    parser.add_argument('--prune_T', type=int, default=10, help='model prune parameter')
    parser.add_argument('--prune_rule', type=int, default=5, help='rule prune parameter')
    ...
    parser.add_argument('--export_entry', type=bool, default=False, help="export_entry")
    parser.add_argument('--export_int', type=bool, default=False, help="export_int")
    ...
    parser.add_argument('--boost_num', type=int, default=5, help='boost iter number')
    ...
    parser.add_argument('--dataset', type=str, default='iscx', help='ton-iot / ISCX / cicids')
    ...
    parser.add_argument('--output_csv', type=str, default="exp_only_init.csv", help='output_csv')
    ...
    parser.add_argument('--save_model', type=str, default='./final_model/iot_ab', help='path to save model')
    ...
    for dataset in [args.dataset]:#'iscx','cicids','ton-iot','unibs',"unsw-iot"
        ...
        if dataset == 'iscx':
            ...
            # 9 23
            # # args.boost_num = 5
            # args.temperature = 0.083587644
            # args.prune_T = 5
            # args.prune_rule = 5
            # args.dbscan_eps = 0.281681929
            ...
            args.cls_threshold = 1.2

            # 9 23
            # # args.boost_num = 5
            # args.temperature = 0.231080124
            # args.prune_T = 12
            # args.prune_rule = 0
            # args.dbscan_eps = 0.238935686761229
            ...
            # # 9 23 
            # # args.boost_num = 5
            # args.temperature = 0.090061845
            # args.prune_T = 7
            # args.prune_rule = 0
            # args.dbscan_eps = 0.04740253

            # args.boost_num = 4
            args.temperature = 0.05
            args.prune_T = 10
            args.prune_rule = 5
            args.dbscan_eps = 0.01
            ...
            # 9 23
            # args.boost_num = 5
            # args.temperature = 0.92940854
            # args.prune_T = 10
            # args.prune_rule = 0
            # args.dbscan_eps = 0.013670911
        ...
        record_list_name = ['dataset','add_order','init_type','choose_threshold','boost_num','temperature','prune_T','prune_rule','dbscan_eps',\
                            'detection_acc','choose_TPR','choose_FPR','final_acc','precision','recall','f1',\
                                'rule_number',"next_rule_num","remain_num","conflict_rule_num","remain_conflict_rules_num","save_num"]
