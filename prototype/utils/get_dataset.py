...
def get_data(args):
    ...
    if args.dataset == 'ton-iot':
        ...
        attack_classes = ['normal', 'Worms','Analysis', 'Backdoor', 'DoS', 'Exploits', 'Fuzzers', 'Generic', 'Reconnaissance', 'Shellcode', ]
...
def get_data_ton_iot(ton_iot_attack_max_samples, ton_iot_selected_class, test_split_size):
    ...
    data = np.load('/home/zhuyijia/prototypical/V6_complete/data_ToN-IoT/ToN-IoT_X.npy').astype(np.int32)
    label = np.load('/home/zhuyijia/prototypical/V6_complete/data_ToN-IoT/ToN-IoT_y.npy').astype(np.int32)
...
def get_data_CICIDS_2018(iscx_attack_max_samples, iscx_selected_class, test_split_size):
    ...
    data = np.load("/home/zhuyijia/prototypical/V6_complete/CICIDS_dataset/V3_CICIDS_2018_X.npy").astype(np.int64)
    label = np.load("/home/zhuyijia/prototypical/V6_complete/CICIDS_dataset/V3_CICIDS_2018_y.npy").astype(np.int64)
...
def get_data_UNSW_NB15(iscx_attack_max_samples, iscx_selected_class, test_split_size):
    ...
    selected_data = np.vstack(selected_data)
    selected_label = np.hstack(selected_label)
    selected_label = selected_label.astype(np.int8)
